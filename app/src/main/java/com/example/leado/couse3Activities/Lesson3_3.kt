...
class Lesson3_3 : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_lesson3_3, container, false)
    }

    override fun onActivityCreated(savedInstanceState: Bundle?) {
        super.onActivityCreated(savedInstanceState)
        next_btn3.setOnClickListener {
            findNavController().navigate(Lesson3_3Directions.actionLesson33ToLesson43())
        }
    }
}